    ...
    def _send_with_retry(
        ...
        *,
        ...
        Args:
            ...
            allowed_statuses: Non-success response codes to return to the caller.
    ...
    def post_raw(
        ...
        *,
        ...
        Args:
            ...
            allowed_statuses: Non-success response codes to return when error handling is enabled.
        """
        url = self.api_url(path)
